...
@section("content")
  ...
  @endif
  <form class="pt-3" method="post" action="{{url('/patient/store')}}">
      {{ csrf_field() }}
          ...
          <div class="card-body">
            ...
            <div class="forms-sample">
              <div class="form-group">
                ...
                <input type="text" name="references" class="form-control" id="exampleInputName1" placeholder="references">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="situation_familiale" id="situation_familiale" placeholder="Situation familiale">
                @error('situation_familiale') <div class="error">{{ $message }}</div> @enderror
              </div>

              <div class="form-group">
                <label for="assurance_medicale">Assurance médical</label>
                <input type="text" class="form-control" name="assurance_medicale" id="assurance_medicale" placeholder="Assurance médical">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="groupe_sanguin" id="groupe_sanguin" placeholder="Groupe sanguin">
                @error('groupe_sanguin') <div class="error">{{ $message }}</div> @enderror
              </div>

              <div class="form-group">
                <label for="nom_pere">Nom du père</label>
                <input type="text" class="form-control" name="nom_pere" id="nom_du_pere" placeholder="Nom du père">
                @error('nom_pere') <div class="error">{{ $message }}</div> @enderror
              </div>

              <div class="form-group">
                <label for="nom_mere">Nom de la mère</label>
                <input type="text" class="form-control" name="nom_mere" id="nom_mere" placeholder="Nom de la mère">
                @error('nom_mere') <div class="error">{{ $message }}</div> @enderror
              </div>

              <div class="form-group">
                <label for="personne_prevenir">Nom de la personne à prévenir</label>
                <input type="text" class="form-control" name="personne_prevenir" id="personne_prevenir" placeholder="Nom de la personne à prévenir">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="telephone_personne_prevenir" id="telephone_personne" placeholder="Telephone de la personne à prévenir">
