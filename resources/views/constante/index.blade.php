...
<link rel="stylesheet" href="https://cdn.datatables.net/1.12.1/css/dataTables.bootstrap.min.css">
  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Liste des constantes</h4>
          ...
          <table id="example" class="table table-striped">
            ...
            <tbody>
                @foreach ($constantes as $constante)
                    ...
                    <tr>
                        <td>
                            {{$constante['nom_patient']}} {{$constante['prenom_patient']}}
                        </td>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Supprimer une constante</h5>
                            ...
                            <div class="modal-footer">
                              ...
                              <form  method="post" action="{{ route('constante.delete', $constante['id']) }}">
                                {{ method_field('DELETE') }}
                                {{  csrf_field() }}
